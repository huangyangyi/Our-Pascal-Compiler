...
ASTRoutineHead::ASTRoutineHead(ASTConstPart *const_part, ASTTypePart *type_part,
    ...
    : const_part(const_part), type_part(type_part), var_part(var_part),
...
ASTRoutineBody::ASTRoutineBody(CompoundStmt *compound_stmt)
...
ASTRoutine::ASTRoutine(ASTRoutineRead *routine_head,
